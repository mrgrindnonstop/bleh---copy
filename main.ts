namespace SpriteKind {
    export const myenemy2 = SpriteKind.create()
...
controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    mySprite.setImage(img`
        ...
        . . f e e f e f f e f e e f . . 
        . . f f f e e e e e e f f f . . 
        . f f e f e f e e f e f e f f . 
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    projectile = sprites.createProjectileFromSprite(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, mySprite, vx, vy)
    music.play(music.createSoundEffect(WaveShape.Sine, 1, 5000, 120, 24, 679, SoundExpressionEffect.Tremolo, InterpolationCurve.Logarithmic), music.PlaybackMode.UntilDone)
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    [img`
        ...
        . . f f e d d f 1 d d d e e f . 
        4 e e d f d d d d d e e e f . . 
        4 e d d f e e e d e e f . . . . 
        4 e e d e d d d 2 2 2 f . . . . 
        . . f b e d d e d d d f f . . . 
        . . . f f e e f f f f f f . . . 
        . . . . f f f . . . f f . . . . 
        `,img`
        . . . . . . . . . . . . . . . . 
    ...
    projectile = sprites.createProjectileFromSprite(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, mySprite, vx, vy)
    music.play(music.createSoundEffect(WaveShape.Square, 652, 2960, 226, 0, 664, SoundExpressionEffect.Tremolo, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
    if (projectile.overlapsWith(myEnemy)) {
        sprites.destroy(myEnemy, effects.none, 1)
        info.changeScoreBy(1)
    }
...
sprites.onOverlap(SpriteKind.FinalBoss, SpriteKind.Player, function (sprite, otherSprite) {
    ...
    game.showLongText("You were infected you loose", DialogLayout.Bottom)
    game.gameOver(false)
})
...
info.onScore(30, function () {
    music.play(music.tonePlayable(131, music.beat(BeatFraction.Half)), music.PlaybackMode.LoopingInBackground)
    music.play(music.tonePlayable(156, music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    ...
    Final_boss.setPosition(154, 113)
    Final_boss.follow(mySprite, 35)
})
...
sprites.onOverlap(SpriteKind.myenemy2, SpriteKind.Player, function (sprite, otherSprite) {
    sprites.destroy(mySprite)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    game.showLongText("You were infected you loose", DialogLayout.Bottom)
    game.gameOver(false)
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.FinalBoss, function (sprite, otherSprite) {
    sprites.destroy(Final_boss)
    game.showLongText("Congrats you survived the zombie apocalypse", DialogLayout.Bottom)
    game.gameOver(true)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.myenemy2, function (sprite, otherSprite) {
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
game.showLongText("get 30 points and kill the boss to win", DialogLayout.Bottom)
...
game.onUpdateInterval(3000, function () {
    myEnemy = sprites.create(img`
        ...
        . f f f f f f f f f f . . 
        f 7 f b 7 . 7 . b f 2 f . 
        2 7 f 7 2 7 7 7 7 f 7 2 . 
        7 7 f 6 . 6 6 . 6 f 2 7 . 
        . . . f f f f f f . . . . 
        . . . f f . . f f . . . . 
        `, SpriteKind.Enemy)
    myEnemy.setBounceOnWall(true)
    myEnemy.setPosition(randint(65, 120), randint(65, 120))
